...
// `System.out.println("The biggest number is: " +BiggestNo);` is printing the message "The biggest
// number is: " followed by the value of the variable `BiggestNo`. It is used to display the result of
